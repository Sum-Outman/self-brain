...
# Mock implementation of ModelRegistry for testing
...
MOCK_TRAINING_HISTORY = [
    {
        'task_id': 'task_17200001',
        'status': 'Completed',
        'timestamp': (datetime.now() - timedelta(minutes=30)).isoformat(),
        'models': ['B_language', 'I_knowledge']
    },
    {
        'task_id': 'task_17200002',
        'status': 'Completed',
        'timestamp': (datetime.now() - timedelta(hours=2)).isoformat(),
        'models': ['D_image']
    },
    {
        'task_id': 'task_17200003',
        'status': 'Failed',
        'timestamp': (datetime.now() - timedelta(hours=4)).isoformat(),
        'models': ['E_video']
    },
    {
        'task_id': 'task_17200004',
        'status': 'Completed',
        'timestamp': (datetime.now() - timedelta(days=1)).isoformat(),
        'models': ['K_programming']
    },
    {
        'task_id': 'task_17200005',
        'status': 'Completed',
        'timestamp': (datetime.now() - timedelta(days=2)).isoformat(),
        'models': ['B_language', 'C_audio']
    }
]
...
# Initialize model registry with mock implementation
model_registry = MockModelRegistry()

# Global variables for storing training history
TRAINING_HISTORY = MOCK_TRAINING_HISTORY.copy()
...
def get_task(task_id):
    ...
    return jsonify({
        ...
        'logs': ['Training started', 'Epoch 13 completed']
    })
...
def stop_task(task_id):
    ...
    try:
        ...
        if success:
            ...
            logger.info(f"Mock stopped training task: {task_id}")
